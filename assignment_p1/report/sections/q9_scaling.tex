...
The macroscale device would resonate at $\sim \textcolor{blue}{\SI{537}{\hertz}}$ instead of
$\textcolor{blue}{\SI{537}{\kilo\hertz}}$.

\paragraph{Gravity displacement ($\propto \alpha^{2}$).}
$x_{g} = m g / k \propto \alpha^{3}/\alpha = \alpha^{2}$.
The $\textcolor{blue}{\SI{0.86}{\pico\meter}}$ deflection becomes $\sim\!\textcolor{blue}{\SI{0.9}{\milli\meter}}$.
...
$\sim\!\textcolor{blue}{2800}\,g$ to a few $g$.
