...
\begin{align}
  ...
  |H|_{f=f_{0}}    &= \frac{S_{\phi}\,\eta\,Q}{k}
                     \;\approx\; \SI{39}{\milli\radian\per\volt}
...
peaks by $20\log_{10}Q\approx \SI{40}{\decibel}$ at the lightly damped
...
$f_{0}\approx\SI{662}{\kilo\hertz}$ exceeds the low-frequency value by a
factor of $Q\approx 97$.}
\label{fig:bode}
\end{figure}
